...
class LocationHelper(private val activity: Activity) :
  ...
  private fun initiateLocationServiceRequest() {
    ...
    val builder =
        LocationSettingsRequest.Builder().addLocationRequest(mLocationRequest).setAlwaysShow(true)
        ...
        when (ex.statusCode) {
          ...
          LocationSettingsStatusCodes.RESOLUTION_REQUIRED ->
              try {
                ...
                resolvableApiException.startResolutionForResult(activity, LOCATION_ENABLE_REQUEST)
